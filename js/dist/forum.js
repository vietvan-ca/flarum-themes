...
var HeroSection = /*#__PURE__*/function (_Component) {
  ...
  _proto.oninit = function oninit(vnode) {
    var _app$session$user, _forum$attribute, _forum$attribute2;
    ...
    this.mode = ((_app$session$user = app.session.user) == null ? void 0 : _app$session$user.preferences().fofNightMode) === 2 ? 'dark' : 'light';
  ...
  _proto.setupNightModeListener = function setupNightModeListener() {
    ...
    document.addEventListener('fofnightmodechange', function (event) {
      ...
      console.log('Hero mode changed to:', _this.mode);
      m.redraw();
    });
  };
