...
class UploadLogoController implements RequestHandlerInterface
{
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        if (isset($uploadedFiles['vietvan_ca_logo'])) {
            $uploadName = 'vietvan_ca_logo';
            $settingKey = 'vietvan_ca_logo_path';
        } elseif (isset($uploadedFiles['vietvan_ca_logo_dark'])) {
            $uploadName = 'vietvan_ca_logo_dark';
            $settingKey = 'vietvan_ca_logo_dark_path';
        } else {
