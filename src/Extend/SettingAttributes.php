...
class SettingAttributes
{
    ...
    public static function extend(): Extend\Settings
    {
        return (new Extend\Settings)
            ...
            ->serializeToForum('vietvan_ca_hero_custom_color_enabled', 'vietvan-ca-themes.hero_custom_color_enabled')
            ->serializeToForum('vietvan_ca_hero_title_color', 'vietvan-ca-themes.hero_title_color')
            ->serializeToForum('vietvan_ca_hero_description_color', 'vietvan-ca-themes.hero_description_color')
